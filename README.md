...
[![QA Labs project dashboard showing requirements, test runs, bug tracking, reports, and coverage](assets/qa-labs-showcase.png)](https://qa-labs-seven.vercel.app/)
...
| Work | What it demonstrates | Verified scope |
| --- | --- | --- |
| **[E-commerce Automation ↗](https://github.com/MKJaswanth/E-commerce_automation)** | Playwright and pytest coverage using page objects, fixtures, parameterization, HTML reports, environment configuration, and GitHub Actions. | 4 core flows: authentication, inventory, cart, and checkout |
| **[Playwright Pytest QA Skill ↗](https://github.com/MKJaswanth/playwright-pytest-qa-skill)** | A reusable workflow for designing, running, and reporting browser tests with Playwright and pytest. | Design → execution → reporting workflow |
| **[QA Portfolio ↗](https://mkjaswanth.github.io/portfolio/)** | Longer-form project context, testing work, and the decisions behind the work. [Source ↗](https://github.com/MKJaswanth/portfolio). | 4+ projects · 200+ test cases per project |
| **[BugAuraLabs ↗](https://bugauralabs.studio/)** | BugAuraLabs is an independent QA services studio I am building for product teams. The site explains testing scope, defect reporting, and engagement options. [Source ↗](https://github.com/MKJaswanth/BugAuraLabs). | SaaS, e-commerce, and agency QA |
...
Away from testing, I am usually listening to music, planning a trip, or reading something new. Anime also finds its way into the visual experiments and small projects I build for fun.
